        ...
        {NAV.map(n => {
          ...
          return (
            <div
              ...
              onMouseDown={() => setPressedPath(n.path)}
              onMouseUp={() => setPressedPath(null)}
              onTouchStart={() => setPressedPath(n.path)}
              onTouchEnd={() => setPressedPath(null)}
              style={{
                flex: 1,
                display: 'flex', flexDirection: 'column', alignItems: 'center',
                padding: '10px 4px 9px', gap: 3, cursor: 'pointer',
